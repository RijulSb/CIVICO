...
;
;
function CitizenSubmissionForm(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(72);
    if ($[0] !== "3bbac6b0029ea481add3660e86e0b152bcb461af55ea421c73a309b21d99f6d7") {
        for(let $i = 0; $i < 72; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "3bbac6b0029ea481add3660e86e0b152bcb461af55ea421c73a309b21d99f6d7";
    }
    const { onSubmitSuccess, className: t1 } = t0;
    ...
    const [language, setLanguage] = __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]("or");
        ...
        t2 = ({
            "CitizenSubmissionForm[useEffect()]": ()=>{
                ...
                const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$lib$2f$offlineQueue$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribeQueueSync"])({
                    "CitizenSubmissionForm[useEffect() > subscribeQueueSync()]": (count)=>{
                        setQueuedCount({
                            "CitizenSubmissionForm[useEffect() > subscribeQueueSync() > setQueuedCount()]": (prev)=>Math.max(0, prev - count)
                        }["CitizenSubmissionForm[useEffect() > subscribeQueueSync() > setQueuedCount()]"]);
                    }
                }["CitizenSubmissionForm[useEffect() > subscribeQueueSync()]"]);
                return ()=>{
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"](t2, t3);
    let t4;
    if ($[3] !== confirmedCoords?.lat || $[4] !== confirmedCoords?.lng || $[5] !== isOnline || $[6] !== language || $[7] !== onSubmitSuccess || $[8] !== photo || $[9] !== text || $[10] !== voice || $[11] !== wardId) {
        t4 = ({
            "CitizenSubmissionForm[handleSubmit]": async (e)=>{
                e.preventDefault();
                ...
                if (!isOnline) {
                    ...
                    setQueuedCount(_CitizenSubmissionFormHandleSubmitSetQueuedCount);
        ...
        })["CitizenSubmissionForm[handleSubmit]"];
        $[3] = confirmedCoords?.lat;
        $[4] = confirmedCoords?.lng;
        $[5] = isOnline;
        $[6] = language;
        $[7] = onSubmitSuccess;
        $[8] = photo;
    ...
    const t5 = `mx-auto flex w-full max-w-lg flex-col gap-6 font-sans ${className}`;
    const t6 = `flex items-center justify-between rounded-xl p-4 font-mono text-xs ${isOnline ? "bg-[#1c2d1c] text-[#eeede9]" : "bg-amber-900 text-amber-100"}`;
    let t7;
    if ($[13] !== isOnline) {
        t7 = isOnline ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$wifi$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Wifi$3e$__["Wifi"], {
    ...
    const t8 = isOnline ? "PWA Online Mode" : "Offline Mode (Auto-Sync Active)";
    let t9;
    if ($[15] !== t8) {
    ...
    let t11;
    if ($[20] !== queuedCount) {
        t11 = queuedCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    let t13;
    if ($[26] !== submitStatus) {
        t13 = submitStatus !== "idle" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    if ($[28] === Symbol.for("react.memo_cache_sentinel")) {
        t14 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
        ...
        t16 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: t15.map({
                        "CitizenSubmissionForm[(anonymous)()]": (lang)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "button",
                                onClick: {
                                    "CitizenSubmissionForm[(anonymous)() > <button>.onClick]": ()=>setLanguage(lang.id)
                                }["CitizenSubmissionForm[(anonymous)() > <button>.onClick]"],
                    ...
                    }["CitizenSubmissionForm[(anonymous)()]"])
                }, void 0, false, {
                    fileName: "[project]/civic-priority-platform/frontend/components/forms/CitizenSubmissionForm.tsx",
                    lineNumber: 202,
                    columnNumber: 108
    ...
    if ($[32] === Symbol.for("react.memo_cache_sentinel")) {
        t17 = ({
            "CitizenSubmissionForm[<VoiceRecorder>.onClear]": ()=>setVoice(null)
        })["CitizenSubmissionForm[<VoiceRecorder>.onClear]"];
        $[32] = t17;
    } else {
        t17 = $[32];
    }
    ...
    if ($[35] === Symbol.for("react.memo_cache_sentinel")) {
        t19 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
    ...
    let t21;
    if ($[39] !== photo) {
        t21 = photo && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$components$2f$forms$2f$ImagePreview$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ImagePreview"], {
            file: photo,
            onRemove: {
                "CitizenSubmissionForm[<ImagePreview>.onRemove]": ()=>setPhoto(null)
            }["CitizenSubmissionForm[<ImagePreview>.onRemove]"],
            className: "mt-2"
        }, void 0, false, {
            fileName: "[project]/civic-priority-platform/frontend/components/forms/CitizenSubmissionForm.tsx",
            lineNumber: 247,
    ...
    if ($[46] === Symbol.for("react.memo_cache_sentinel")) {
        t24 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
            htmlFor: "issue-desc",
            className: "font-mono text-xs font-semibold text-[#171817] uppercase tracking-wider",
    ...
    if ($[47] === Symbol.for("react.memo_cache_sentinel")) {
        t25 = ({
            "CitizenSubmissionForm[<textarea>.onChange]": (e_0)=>setText(e_0.target.value)
        })["CitizenSubmissionForm[<textarea>.onChange]"];
        $[47] = t25;
    } else {
        t25 = $[47];
    }
    ...
    let t27;
    if ($[50] !== isSubmitting || $[51] !== photo || $[52] !== text || $[53] !== voice) {
        t27 = isSubmitting || !text.trim() && !voice && !photo;
        $[50] = isSubmitting;
        $[51] = photo;
        $[52] = text;
        $[53] = voice;
    ...
    let t28;
    if ($[55] !== isOnline || $[56] !== isSubmitting) {
        t28 = isSubmitting ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t29;
    if ($[58] !== t27 || $[59] !== t28) {
        t29 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            type: "submit",
            disabled: t27,
    ...
    let t30;
    if ($[61] !== handleSubmit || $[62] !== t12 || $[63] !== t13 || $[64] !== t16 || $[65] !== t18 || $[66] !== t22 || $[67] !== t23 || $[68] !== t26 || $[69] !== t29 || $[70] !== t5) {
        t30 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
...
_s(CitizenSubmissionForm, "wNdVQ3epJPGezTUrYf4sGH+KKdY=");
_c = CitizenSubmissionForm;
function _temp(r) {
    return setTimeout(r, 800);
}
function _CitizenSubmissionFormHandleSubmitSetQueuedCount(prev_0) {
    return prev_0 + 1;
}
...
//# sourceMappingURL=civic-priority-platform_frontend_10j-pi_._.js.map