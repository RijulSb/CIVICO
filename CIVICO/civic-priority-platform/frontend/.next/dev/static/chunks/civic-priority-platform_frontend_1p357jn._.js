        ...
        priorityPulse: [
            {
                ...
                submissionCount: 943,
                affectedWards: 7,
                affectedPopulation: 38100,
                trendPercent: 24,
                signalScore: 88.2,
                priority: "high",
                urgency: "high",
                infraGap: "Coastal salinity contaminating groundwater; 5 wards rely on tankers."
            },
            {
                theme: "road_repair",
                label: "Road Repair",
                submissionCount: 712,
                affectedWards: 6,
                affectedPopulation: 29500,
                trendPercent: 14,
                signalScore: 79.5,
                priority: "high",
                urgency: "high",
                infraGap: "Heritage town roads deteriorated; pilgrim access routes in poor condition."
            },
            {
                theme: "health_access",
                label: "Health Access",
                submissionCount: 514,
                affectedWards: 5,
                affectedPopulation: 22800,
                trendPercent: 11,
                signalScore: 71.3,
                priority: "medium",
                urgency: "medium",
                infraGap: "Seasonal overcrowding of district hospital during pilgrimage season."
            },
            {
                theme: "school_infrastructure",
                label: "School Infrastructure",
                ...
                priority: "medium",
                urgency: "medium",
                infraGap: "Cyclone-damaged school buildings unreplaced in 2 coastal wards."
            },
            {
                theme: "street_lighting",
                label: "Street Lighting",
                ...
                priority: "emerging",
                urgency: "low",
                infraGap: "Fishing village lanes unlit; safety concerns raised."
            }
        ],
        hotspots: [
            {
                id: "puri_hotspot_ward4_water",
                ward: "Ward 4",
                block: "Puri Block",
                theme: "water_supply",
                latitude: 19.8120,
                ...
                suggestedProject: {
                    title: "Install RO water plant and pipeline in Ward 4",
                ...
                representativeEvidence: [
                    {
                        type: "voice",
                        language: "odia",
                        translatedText: "The well water is salty and undrinkable. We buy water every day."
                    }
                ]
            },
            {
                id: "puri_hotspot_ward7_road",
                ward: "Ward 7",
                block: "Puri Block",
                theme: "road_repair",
                latitude: 19.8180,
                ...
                infrastructureContext: {
                    roadCondition: "poor",
                    pilgrimTrafficDaily: 12000
                },
                suggestedProject: {
                    title: "Repair 3.1 km pilgrim access road in Ward 7",
                ...
                representativeEvidence: [
                    {
                        type: "text",
                        language: "odia",
                        translatedText: "Pilgrims and residents both suffer on these broken roads."
                    }
                ]
            },
            {
                id: "puri_hotspot_ward2_health",
                ward: "Ward 2",
                block: "Puri Block",
                theme: "health_access",
                latitude: 19.8060,
                ...
                candidateProjectId: null,
                infrastructureContext: {
                    nearestPHCDistanceKm: 4.8,
                    seasonalCongestion: true
                },
                suggestedProject: {
                    title: "Open satellite health clinic in Ward 2",
                ...
                representativeEvidence: [
                    {
                        type: "voice",
                        language: "odia",
                        translatedText: "During festivals, even emergencies cannot reach the hospital quickly."
                    }
                ]
            }
        ],
        recentSubmissions: [
            {
                ...
                channel: "voice",
                preview: "Odia voice report",
                translatedPreview: "The water has become too salty to drink.",
                submittedMinsAgo: 7
            },
            {
                id: "puri_sub_002",
                ...
                channel: "text",
                preview: "Hindi text report",
                translatedPreview: "The road is in very poor condition.",
                submittedMinsAgo: 19
            }
        ]
    },
        ...
        priorityPulse: [
            {
                theme: "road_repair",
                label: "Road Repair",
                submissionCount: 1105,
                affectedWards: 9,
                affectedPopulation: 51200,
                trendPercent: 21,
                signalScore: 89.7,
                priority: "high",
                urgency: "high",
                infraGap: "Flood-damaged roads unrepaired; arterial bridge overloaded."
            },
            {
                theme: "health_access",
                label: "Health Access",
                submissionCount: 768,
                affectedWards: 6,
                affectedPopulation: 33400,
                trendPercent: 16,
                signalScore: 81.2,
                priority: "high",
                urgency: "high",
                infraGap: "SCB Medical College overloaded; no satellite health centres in 6 wards."
            },
            {
                theme: "water_supply",
                label: "Water Supply",
                submissionCount: 542,
                affectedWards: 5,
                affectedPopulation: 24600,
                trendPercent: 8,
                signalScore: 70.4,
                priority: "medium",
                urgency: "medium",
                infraGap: "Mahanadi flooding contaminates water supply annually."
            },
            {
                theme: "school_infrastructure",
                label: "School Infrastructure",
                ...
                priority: "medium",
                urgency: "medium",
                infraGap: "Old municipal school buildings with leaking roofs and no labs."
            },
            {
                theme: "street_lighting",
                label: "Street Lighting",
                ...
                priority: "emerging",
                urgency: "low",
                infraGap: "Old town lanes and silver market area dark after 9 PM."
            }
        ],
        hotspots: [
            {
                id: "cuttack_hotspot_ward6_road",
                ward: "Ward 6",
                block: "Cuttack Block",
                theme: "road_repair",
                latitude: 20.4625,
                ...
                infrastructureContext: {
                    roadCondition: "poor",
                    floodingFrequency: "annual",
                    dailyCommuters: 8500
                },
                suggestedProject: {
                    title: "Rebuild 5.2 km flood-prone road in Ward 6",
                ...
                representativeEvidence: [
                    {
                        type: "voice",
                        language: "odia",
                        translatedText: "Every monsoon the road disappears. We are cut off for weeks."
                    }
                ]
            },
            {
                id: "cuttack_hotspot_ward3_health",
                ward: "Ward 3",
                block: "Cuttack Block",
                theme: "health_access",
                latitude: 20.4710,
                ...
                candidateProjectId: null,
                infrastructureContext: {
                    nearestPHCDistanceKm: 7.1,
                    ambulanceCoverage: false
                },
                suggestedProject: {
                    title: "Establish maternity and primary care unit in Ward 3",
                ...
                representativeEvidence: [
                    {
                        type: "voice",
                        language: "hindi",
                        translatedText: "There is no doctor close by. Women in labour are transported in autorickshaws."
                    }
                ]
            },
            {
                id: "cuttack_hotspot_ward9_water",
                ward: "Ward 9",
                block: "Cuttack Block",
                theme: "water_supply",
                latitude: 20.4560,
                ...
                candidateProjectId: null,
                infrastructureContext: {
                    pipedWaterCoverage: "44%",
                    floodContamination: true
                },
                suggestedProject: {
                    title: "Install water treatment and storage units in Ward 9",
                ...
                representativeEvidence: [
                    {
                        type: "text",
                        language: "odia",
                        translatedText: "After floods, tap water smells bad and causes illness."
                    }
                ]
            }
        ],
        recentSubmissions: [
            {
                ...
                channel: "voice",
                preview: "Odia voice report",
                translatedPreview: "The road gets submerged in the rain.",
                submittedMinsAgo: 6
            }
        ]
    },
        ...
        priorityPulse: [
            {
                ...
                submissionCount: 876,
                affectedWards: 7,
                affectedPopulation: 44100,
                trendPercent: 28,
                signalScore: 84.3,
                priority: "high",
                urgency: "high",
                infraGap: "IT corridor outskirts and new layouts without street lights; safety concerns rising."
            },
            {
                theme: "road_repair",
                label: "Road Repair",
                submissionCount: 734,
                affectedWards: 6,
                affectedPopulation: 37200,
                trendPercent: 12,
                signalScore: 77.8,
                priority: "high",
                urgency: "high",
                infraGap: "Rapid construction traffic damaged internal wards roads."
            },
            {
                theme: "water_supply",
                label: "Water Supply",
                ...
                priority: "medium",
                urgency: "medium",
                infraGap: "New residential zones lack pipeline connection; rely on private tankers."
            },
            {
                theme: "school_infrastructure",
                label: "School Infrastructure",
                ...
                priority: "medium",
                urgency: "medium",
                infraGap: "Rapid population growth has outpaced school capacity in 4 wards."
            },
            {
                theme: "health_access",
                label: "Health Access",
                ...
                priority: "emerging",
                urgency: "low",
                infraGap: "Peripheral wards added after BMC expansion have no PHC assigned."
            }
        ],
        hotspots: [
            {
                id: "bbsr_hotspot_ward11_light",
                ward: "Ward 11",
                block: "Bhubaneswar North",
                theme: "street_lighting",
                latitude: 20.3200,
                longitude: 85.8100,
                intensity: "high",
                submissionCount: 112,
                affectedPopulation: 16400,
                evidenceCounts: {
                    text: 58,
                    voice: 36,
                    photo: 18
                ...
                suggestedProject: {
                    title: "Install 380 LED streetlights in Ward 11 IT corridor",
                ...
                representativeEvidence: [
                    {
                        type: "voice",
                        language: "english",
                        translatedText: "The road from the tech park to our colony has no lights. It is unsafe at night."
                    }
                ]
            },
            {
                id: "bbsr_hotspot_ward5_road",
                ward: "Ward 5",
                block: "Bhubaneswar Central",
                theme: "road_repair",
                latitude: 20.2961,
                longitude: 85.8245,
                intensity: "high",
                ...
                suggestedProject: {
                    title: "Rehabilitate 3.4 km construction-damaged road in Ward 5",
                ...
                representativeEvidence: [
                    {
                        type: "text",
                        language: "english",
                        translatedText: "Construction trucks have destroyed the road surface."
                    }
                ]
            }
        ],
        recentSubmissions: [
            {
                ...
                language: "english",
                channel: "text",
                preview: "No lights on the road near tech park.",
                translatedPreview: "No lights on the road near tech park.",
                submittedMinsAgo: 9
            }
        ]
    }
};
const FALLBACK = CONSTITUENCY_FALLBACKS.khordha;
...
function TrendBadge(t0) {
    ...
    if ($[0] !== "060429889360f069e0bd1d1fc1d036baa08d51c1477e5fe91606555f64710d0d") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "060429889360f069e0bd1d1fc1d036baa08d51c1477e5fe91606555f64710d0d";
    }
    const { value } = t0;
    if (value === 0) {
        let t1;
    ...
    const fetchData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$priority$2d$platform$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DashboardPage.useCallback[fetchData]": async ()=>{
            ...
            try {
                ...
                setData(nextData);
                const firstHotspot_0 = nextData.hotspots[0] ?? null;
                setSelectedHotspot(firstHotspot_0);
                // Smoothly pan map to new constituency location
                const center_0 = CONSTITUENCY_CENTERS[constituency] || (firstHotspot_0 ? {
                    lat: firstHotspot_0.latitude,
                    lng: firstHotspot_0.longitude,
                    zoom: 12
                } : null);
                if (center_0) {
                    mapRef.current?.flyTo(center_0.lat, center_0.lng, center_0.zoom);
                }
            } catch  {
                ...
                const center = CONSTITUENCY_CENTERS[constituency] || (firstHotspot ? {
                    lat: firstHotspot.latitude,
                    lng: firstHotspot.longitude,
                    zoom: 12
                } : null);
                if (center) {
...
//# sourceMappingURL=civic-priority-platform_frontend_1p357jn._.js.map