    ...
    if content_type.startswith("multipart/form-data"):
        ...
        try:
            payload = SubmissionRequest(
                ...
                submission_type=str(form.get("submission_type") or "text"),
                content=str(form.get("content") or ""),
                audio_url=str(form.get("audio_url")) if form.get("audio_url") else None,
                photo_url=str(form.get("photo_url")) if form.get("photo_url") else None,
                video_url=str(form.get("video_url")) if form.get("video_url") else None,
                full_name=str(form.get("full_name")) if form.get("full_name") else None,
                ...
                citizen_id=str(form.get("citizen_id")) if form.get("citizen_id") else None,
                location=SubmissionLocation(
                    ward=str(form.get("ward") or "unknown"),
                    block=str(form.get("block") or "unknown"),
                    ...
                    custom_text=str(form.get("custom_location_text")) if form.get("custom_location_text") else None,
                ),
                custom_location_text=str(form.get("custom_location_text")) if form.get("custom_location_text") else None,
