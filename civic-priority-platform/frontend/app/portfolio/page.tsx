...
export default function PortfolioPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f6f7f5] text-[#171817]">
      <Header />
      <LockedOverlay
        pageTitle="Constituency Portfolio Command"
        pageDescription="Official integer linear programming workspace for budget allocation, ward equity balance, and project dependencies."
      >
